...
function stop(me) {
	if (drawMode == 'drawLine'){
		...
		var rectObj = new ShapeObj("Rectangle", new coord(startX, startY), new coord(curX, curY), myContext.strokeStyle, myContext.fillStyle, objID++);
		objArr.push(rectObj);
		...
		// 사각형 도형 객체 생성, 도형 배열에 추가
		var ellObj = new ShapeObj("Ellipse", new coord(startX, startY), new coord(curX, curY), myContext.strokeStyle, myContext.fillStyle, objID++);
		objArr.push(ellObj);
